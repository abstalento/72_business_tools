describe('invoice', () => {
    it('passes', () => {
      cy.visit('http://localhost:3000/invoicegenerator')
      cy.get('#color1').click()
      cy.wait(2000)
      cy.get('#color4').click()
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get('#sellerGst').type('22AAAAAA00000J25')
      cy.wait(2000)
      cy.get('#paymentTerms').type('Debit')
      cy.wait(2000)
      cy.get('#billTO').type('Tirunelveli')
      cy.wait(2000)
      cy.get('#buyerGst').type('22AAAAAA00000J25')
      cy.wait(2000)
      ...
      cy.wait(2000)
      cy.get(' #cpercent').clear().type(5)
      cy.wait(2000)
      cy.get(' #spercent').clear().type(10)
      cy.wait(2000)
